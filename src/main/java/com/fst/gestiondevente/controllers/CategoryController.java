...
public class CategoryController 
{
	...
	public String ajout(@RequestParam("nom") String nom)
	{
	    ...
	    category.setNom(nom);  // Set other properties as needed
	    // Add logic to retrieve or initialize the list of products
	    category.setProduits(new ArrayList<>());  // Initialize an empty list for now
